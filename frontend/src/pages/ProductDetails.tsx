...
import { FaArrowRightLong, FaChevronLeft, FaChevronRight, FaPlus } from 'react-icons/fa6'
...
const ProductDetails = () => {
    ...
    const [leftScrolledToEnd, setLeftScrolledToEnd] = useState(false);
    ...
    return (
        <>
            <div className='max-w-7xl mx-auto px-4 flex h-[700px]'>
                ...
                <div
                    ref={rightRef}
                    className={`w-1/2 pt-16 px-8 transition-all duration-200 ${leftScrolledToEnd ? 'relative' : 'sticky top-0'} max-h-[700px]`}
                >
                    {showZoom && (
                        <div
                    ...
                    <div className='flex justify-start items-center space-x-1 font-poppins text-xs text-gray-800 font-medium'>
                        ...
                        <span>/</span>
                        <span className=''>Bread & Pav</span>
                        <span>/</span>
                        <span className='text-gray-500'>Britannia Vitarich Sandwich White Bread</span>
                    </div>
                    <div className='flex flex-col items-start justify-center my-2.5 space-y-0.5'>
                        <h1 className='font-poppins font-bold text-xl'>Britannia Vitarich Sandwich White Bread</h1>
                        <div className="flex items-center space-x-1 bg-[#f8f8f8] rounded w-fit px-1 py-0.5">
                            <LuTimer className="h-3 w-3 flex-shrink-0" />
                            <span className="text-[9px] font-okraish font-bold uppercase tracking-wide text-gray-900">8 mins</span>
                        </div>
                    </div>
                    ...
                    <div className='flex justify-between items-center my-4'>
                        <div className=''>
                            <p className='font-poppins font-semibold text-xs text-gray-500'>350g</p>
                            <p className='my-0.5 font-bold text'>₹40</p>
                            <p className='text-[10px] font-medium text-gray-500'>(inclusive of all taxes)</p>
                        </div>
                        <div>
                            <button className='bg-darkGreen text-white font-poppins px-4 py-2 rounded-md'>
                                Add to cart
                            </button>
                        </div>
                    </div>
